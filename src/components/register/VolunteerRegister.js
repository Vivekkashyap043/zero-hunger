...
return (
    <div >
        <form onSubmit={handleSubmit(onVolunteerRegister)}>
    <div class="main-custom">
      <div class="left">
        <div class="up">
          <h1 className="donate mt-0">Ready to Volunteer?</h1>
          <p className="fs-5 m-0">Register here</p>
          <div className="icons">
          ...
          <p className="mt-0">⎯⎯⎯⎯ or use your account ⎯⎯⎯⎯</p>
        </div>
        <div>
          <div className="in1">
